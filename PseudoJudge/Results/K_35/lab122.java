			...
			if(v.city==src){
				for(int i=1;i<ver.length;i++){
					if(graph[v.city][ver[i].city]!=null&&ver[i].visit==false&&v.time!=Integer.MAX_VALUE){
						if(graph[v.city][ver[i].city].arrivalatc2-graph[v.city][ver[i].city].departfromc1+v.time<ver[i].time&&graph[v.city][ver[i].city].departfromc1>=starttime){
							ver[i].time=0;
				...
				for(int i=1;i<ver.length;i++){
					if(graph[v.city][ver[i].city]!=null&&ver[i].visit==false&&v.time!=Integer.MAX_VALUE){ 			
						if(graph[v.city][ver[i].city].arrivalatc2-graph[v.city][ver[i].city].departfromc1+v.time+graph[v.city][ver[i].city].departfromc1-v.arrivaltime<ver[i].time&&graph[v.city][ver[i].city].departfromc1>=starttime&&graph[v.city][ver[i].city].departfromc1>=v.arrivaltime){
							ver[i].time=0;
