...
public class Graph
{
    ...
    //	System.out.println("N2 aur V aaye"+n2+v);
    	if(w.a<t2 && w.d>t1 && w.a<2300 && w.d>0500)
    		{
    			...
    			{
    				front[v].next=w;
    				//System.out.println(front[v].c2+" ka next hai "+ w.c2);
    				front[v]=front[v].next;
...
//    static String[] full=new String[V]; 
                                  ...
                                  node path[], int path_index,node i)
    {
        ...
        path[path_index] = i;
    //    System.out.println("u "+u+ " flight "+ i.f);
        path_index++;
        ...
        else 
        {
            ...
            { 
            	//System.out.println("i2.f "+ i2.f+" visited "+ visited[i2.c2]+" "+i2.next);
            //	visited[2]=false;
            	if (!visited[i2.c2])
                {
